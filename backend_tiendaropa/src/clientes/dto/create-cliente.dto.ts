...
export class CreateClienteDto {
  ...
  @MaxLength(250, {
    message: 'El campo nombres no debe ser nemor a 250 caracteres',
  })
  ...
  @MaxLength(250, {
    message: 'El campo apellidos no debe ser nemor a 250 caracteres',
  })
  @MinLength(4, {
  ...
  @MaxLength(250, {
    message: 'El campo email no debe ser nemor a 250 caracteres',
  })
